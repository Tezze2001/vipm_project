...
def apply_transformations_and_save(csv_path, input_dir, output_dir, seed=None):
    ...
    # Scansiona le immagini specificate nel CSV
    for _, row in data.iterrows():
        ...
        # Randomizza quali trasformazioni applicare
        transformations = []
...
apply_transformations_and_save(csv_tr, input_dir, output_dir, seed=42)
